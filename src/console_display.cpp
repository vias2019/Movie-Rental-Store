...
/**
 * displayInventory - Display the rental system inventory to stdout
 *
 * @param items The list of items in the rental sytsem inventory in sorted order
 */
void ConsoleDisplay::displayInventory(
...
/**
 * displayHistory - Display a customer's transaction history to stdout
 *
 * @param customerID The id number of the customer.
 * @param transactions The list of transactions in the customer's history.
 */
void ConsoleDisplay::displayHistory(
        int customerID, std::vector<Customer::History> transactions) const
{
    std::cout << '\n';
    std::cout << "Transaction history for customer " << customerID << ":\n";
    std::cout << "--------------------------------------\n";
    std::for_each(std::cbegin(transactions), std::cend(transactions),
...
/**
 * displayError - Display an error message to stderr
 *
