...
/**
 * Constructor - Construct a restock command object.
 *
...
/**
 * runWith - Ask the rental system to execute the restock command.
 *
...
/**
 * customerID - Get the customer id for the customer returning the item.
 *
...
/**
 * item - Get the item the customer is returning.
 *
